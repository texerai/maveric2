...
// ----------------------------------------------------------------------
// This module is PMP check module for IF module.
// ----------------------------------------------------------------------
...
(
    ...
    assign access_lo = addr_i[PA_W - 1:0];
    assign access_hi = addr_i[PA_W - 1:0] + {{(PA_W - 3){1'b0}}, 3'd3};
    ...
    always_comb begin
        if (((priv_mode_i == csr_pkg::PRIV_M) && pmp_data_i.L[0]) || (priv_mode_i < csr_pkg::PRIV_M)) begin
            casez (overlap)
                16'bzzzzzzzzzzzzzzz1: permitted = contains[0] && pmp_data_i.X[0];
                16'bzzzzzzzzzzzzzz10: permitted = contains[1] && pmp_data_i.X[1];
                16'bzzzzzzzzzzzzz100: permitted = contains[2] && pmp_data_i.X[2];
                16'bzzzzzzzzzzzz1000: permitted = contains[3] && pmp_data_i.X[3];
                16'bzzzzzzzzzzz10000: permitted = contains[4] && pmp_data_i.X[4];
                16'bzzzzzzzzzz100000: permitted = contains[5] && pmp_data_i.X[5];
                16'bzzzzzzzzz1000000: permitted = contains[6] && pmp_data_i.X[6];
                16'bzzzzzzzz10000000: permitted = contains[7] && pmp_data_i.X[7];
                16'bzzzzzzz100000000: permitted = contains[8] && pmp_data_i.X[8];
                16'bzzzzzz1000000000: permitted = contains[9] && pmp_data_i.X[9];
                16'bzzzzz10000000000: permitted = contains[10] && pmp_data_i.X[10];
                16'bzzzz100000000000: permitted = contains[11] && pmp_data_i.X[11];
                16'bzzz1000000000000: permitted = contains[12] && pmp_data_i.X[12];
                16'bzz10000000000000: permitted = contains[13] && pmp_data_i.X[13];
                16'bz100000000000000: permitted = contains[14] && pmp_data_i.X[14];
                16'b1000000000000000: permitted = contains[15] && pmp_data_i.X[15];
