...
(
    ...
    logic [1:0] op_5_func7_5;

    assign op_5_func7_5 = {op_5_i, func7_5_i};
    ...
    always_comb begin
        ...
        case (alu_op_i)
            ...
            3'b010:
                case (func3_i)
                    // I extension.
                    3'b000: if (op_5_func7_5 == 2'b11) alu_control_o = 5'b00001;    // SUB.
            ...
            3'b011:
                case (func3_i)
                    // I extension
                    3'b000: if (op_5_func7_5 == 2'b11) alu_control_o = 5'b01011;   // SUBW.
