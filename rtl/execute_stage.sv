...
(
    ...
    assign ex_mem_o.write_data       = write_data;
    ...
    assign ex_mem_o.csr_write_addr   = id_ex_i.csr_addr;
    assign ex_mem_o.csr_read_data    = csr_read_data;
