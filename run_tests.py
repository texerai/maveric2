...
def initial_note():
    with open(RESULT_FILE, 'w') as file_out:
        message_1 = ("NOTE 1: ILLEGAL INSTRUCTION REFERS TO INSTRUCTIONS THAT WERE NOT (YET) IMPLEMENTED IN MAVERIC CORE 2.0 PROCESSOR."
                     " THE SYSTEM REGOGNIZES THOSE INSTRUCTIONS AS ILLEGAL.\n"
                     "THE LIST INCLUDES, BUT IS NOT LIMITED TO, MUL, DIV, AND FENCE INSTRUCTIONS.\n"
                     "\nNOTE 2: THE LOW LEVELS OF BRANCH PREDICTION ACCURACY IN GIVEN TESTS ARE ASSOCIATED WITH VERY HIGH NUMBER OF BRANCHES THAT ARE TAKEN"
                     " ONLY ONCE IN RV-ARCH-TEST AND\nWITH A SMALL TOTAL NUMBER OF BRANCHES IN RV-TESTS.\n")
